...
- Admin: public `/` landing; Discord OAuth if `SUPERADMIN_DISCORD_ID` + Discord client id/secret; extra Discord IDs in Admin Status (superadmin); optional Basic `admin` / `ADMIN_PASSWORD`. UI at `/admin`.
